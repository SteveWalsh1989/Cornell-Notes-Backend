...
var CreateTables = map[string]string{
	...
	"notes":         "CREATE TABLE notes (id VARCHAR(36) NOT NULL PRIMARY KEY, title VARCHAR(36), note VARCHAR(100), status VARCHAR(10) DEFAULT 'Active', date_created datetime, date_edited datetime );",
	...
	"tags":          "CREATE TABLE tags (id VARCHAR(36) NOT NULL PRIMARY KEY, title VARCHAR(36), user_id VARCHAR(36), status VARCHAR(10) DEFAULT 'Active', date_created datetime, date_edited datetime);",
